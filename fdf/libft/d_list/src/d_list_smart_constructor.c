...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   d_list_smart_constructor.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dowon <dowon@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/25 13:12:39 by dowon             #+#    #+#             */
/*   Updated: 2023/06/27 23:11:14 by dowon            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	smart_delete_d_list_all(t_smart_manager *manager, t_d_list *node)
{
	t_d_list	*del_node;
	...
	t_smart_manager *manager, size_t n, t_destructor destructor, ...)
{
	...
	while (--n > 0)
	{
		...
		if (new_node == NULL)
		{
			smart_delete_d_list_all(manager, head);
			return (NULL);
		}
